...
# check for cuda availaibility. If yes, set device to cuda
...
def image_demo():
    ...
    detect_image(dbface, "image.jpg")
    detect_image(dbface, "image2.jpg")
...
def video_demo():
    ...
    dbface.load("model/dbfaceSmallH.pth")
    cap = cv2.VideoCapture("test/rally2.mp4")
